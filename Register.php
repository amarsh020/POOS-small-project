...
else
{
    ...
    if ($result->num_rows > 0){
        ...
        returnWithError("Error: Username already exists. Please choose a different username.");
    }else{

        //Username doesn't exist in db
        $hashed_password = password_hash($password, PASSWORD_DEFAULT); // Hash the password here
